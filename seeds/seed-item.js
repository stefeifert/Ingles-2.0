...
new Item ({ item:"Wine - Sauvignon Blanc Noble",price:0.74,quantity:86, filename: 'wine-sauvignon-blanc-noble.png'}),
new Item ({ item:"Beef - Tenderloin",price:2.66,quantity:81, filename: 'beef-tenderloin.png'}),
...
new Item ({ item:"Cheese - Mozzarella",price:0.55,quantity:87, filename: 'cheese-mozarella.png'}),
new Item ({ item:"Soho Lychee Liqueur",price:4.48,quantity:74, filename: 'soho-lychee-liqueur.png'}),
new Item ({ item:"Vinegar - White Wine",price:4.93,quantity:54, filename: 'vinegar-white-wine.png'}),
new Item ({ item:"Pasta - Spaghetti, Dry",price:3.46,quantity:72, filename: 'pasta-spaghetti.png'}),
...
new Item ({ item:"Wine - Red, Mosaic Zweigelt",price:3.64,quantity:57, filename: 'wine-red-mosaic-zweigelt.png'}),
new Item ({ item:"Star Fruit",price:0.31,quantity:82, filename: 'star-fruit.png'}),
new Item ({ item:"Liners - Baking Cups",price:3.70,quantity:70, filename: 'liners-baking-cups.png'}),
new Item ({ item:"Appetizer - Lobster Phyllo Roll",price:1.76,quantity:68, filename: 'appetizer-lobster-phyllo-roll.png'}),
new Item ({ item:"Wine - Pinot Noir Woodwork",price:12.36,quantity:75, filename: 'wine-pinot-noir-woodwork.png'}),
...
new Item ({ item:"Beets",price:4.44,quantity:60, filename: 'beets.png'}),
new Item ({ item:"Juice - Tomato, 10 Oz",price:0.63,quantity:49, filename: 'juice-tomato.png'}),
...
new Item ({ item:"Garbage Bags - Black",price:1.49,quantity:67, filename: 'garbage-bags-black.png'}),
new Item ({ item:"Wine - Claret Cabernet Coppola",price:21.84,quantity:65, filename: 'wine-claret-cabernet-coppola.png'}),
new Item ({ item:"Salmon - Atlantic, No Skin",price:0.51,quantity:95, filename: 'atlantic-salmon.png'}),
new Item ({ item:"Soup - Campbells Mushroom",price:3.82,quantity:51, filename: 'soup-campbells-mushroom.png'}),
new Item ({ item:"Tortillas - Mission Super Soft",price:2.64,quantity:94, filename: 'tortillas-mission-super-soft.png'}),
new Item ({ item:"Pasta - Emma Gnocchi",price:4.74,quantity:55, filename: 'pasta-emma-gnocchi.png'}),
new Item ({ item:"Lamb - Shoulder, Boneless",price:0.74,quantity:84, filename: 'lamb-shoulder.png'}),
new Item ({ item:"Vanilla Beans",price:0.19,quantity:73, filename: 'vanilla-bean.png'}),
...
new Item ({ item:"Kraken Rum",price:2.24,quantity:92, filename: 'kraken-rum.png'}),
new Item ({ item:"Shrimp - Black Tiger 13/15",price:10.26,quantity:76, filename: 'shrimp.png'}),
new Item ({ item:"Tofu - Extra Firm Hodo",price:1.02,quantity:43, filename: 'tofu-extra-firm-hodo.png'}),
new Item ({ item:"Cookie Scoop",price:2.58,quantity:83, filename: 'cookie-scoop.png'}),
